<template>
  <div class="container mx-auto px-5 py-24 md:flex-row items-center">
    <div class="flex justify-center items-center text-center">
      <h1 class="font-normal font-beranda w-auto text-black text-3xl sm:text-5xl">Klasmen</h1>
    </div>
    <div class="xl:pl-36 container mx-auto flex px-5 py-24 md:flex-row flex-col items-center xl:pr-28">
      <div class="flex flex-col lg:flex-row p-5 space-y-10 sm:space-y-0 sm:space-x-10">
